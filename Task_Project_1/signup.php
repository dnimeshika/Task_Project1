                ...
                <div class="row">
                        <div class="col-lg-12">
                            <div class="heading-text text-center pt-20">
                                ...
                                <p style="margin-bottom: 40px;">Have a account? <a href="signin.php" > Sign In</a></p>
                                
                                <form class="form" action="signupcon.php" method="POST">
                                    <div class="form-Sign" >
                                        <input type="text"  class="signup-form" style="text-align:left;"name="firstname" placeholder="First " autofocus>
                                        <input type="text"  class="signup-form" style="text-align:left;"name="username" placeholder="Username" autofocus>
                                    </div>
                                    <div class="form-Sign">
